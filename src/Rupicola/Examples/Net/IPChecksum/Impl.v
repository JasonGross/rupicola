...
Section Properties.
  ...
  Definition word_onec_add16 (w1 w2: word) :=
    ...
    Zmod.add (Zmod.and sum (bits.of_Z _ 65535)) (word.sru sum 16).
  ...
  Proof.
    ...
    { intros.
      ...
      eapply (In_map_combine_in_bounds (width := 32) 2); eassumption || lia. }
    { intros * Hin%(In_map_combine_in_bounds (width := 32) 2 ltac:(lia)) Ha0.
